...
parser.add_argument('--target',type=str,default='heart18',help='input, star16, heart18, target1 or target2')
parser.add_argument('--dim',type=int,default=9,help='input dimension')
parser.add_argument('--plot',default=True,action='store_true',help='show intermediate plots')
...
if args.target == 'input':
    # input dim=d;  generate identity matrix with shape(dim=d, dim=d)
...
train_loader = torch.utils.data.DataLoader(xor_dataset, batch_size=num_in, num_workers=2)
